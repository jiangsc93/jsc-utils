 ...
 * @returns {boolean}
 */
const isUrl = (value) => URL_RE.test(value);
// ipv4
 ...
 * @returns {boolean}
 */
const isIpV4 = (value) => IPV4_RE.test(value);
...
export { isDigit, isEmail, isFloat, isIdNo, isInteger, isIpV4, isNumerical, isPhone, isUrl };
